package com.deemo.widget.indicator;
...
public class ViewPagerIndicator extends View {
    ...
    private void initPaint() {
        ...
        paintFill.setColor(mDefault_color);
        paintFill.setAntiAlias(true);
        paintFill.setStrokeWidth(AutoSizeUtils.mm2px(getContext(),3));
        //空心
        paintStroke.setStyle(Paint.Style.STROKE);
        paintStroke.setColor(mDefault_color);
        paintStroke.setAntiAlias(true);
        paintStroke.setStrokeWidth(AutoSizeUtils.mm2px(getContext(),3));
    }
    ...
    private void setStyleable(Context context, AttributeSet attrs) {
        ...
        mSelected_color = array.getColor(R.styleable.ViewPagerIndicator_vpi_selected_color, 0xFF03318C);
        mDefault_color = array.getColor(R.styleable.ViewPagerIndicator_vpi_default_color, 0xFF03318C);
