package com.deemo.widget.countdown;
...
public class CountdownView extends View {
    ...
    private long mMilliseconds; //计时的总毫秒数
    ...
    private void calculateValue() {
        //文字
        int hours = (int) (mMilliseconds / (1000 * 60 * 60));
        int minutes = (int) ((mMilliseconds % (1000 * 60 * 60)) / (1000 * 60));
        int seconds = (int) ((mMilliseconds - hours * (1000 * 60 * 60) - minutes * (1000 * 60)) / 1000);
        int milliSec = (int) (mMilliseconds % 1000 / 100);
        if (hours == 0) {
        ...
        //外角度
        outerAngle = (int) (360 * (mMilliseconds % 60000) / 60000);
        //内角度
        innerAngle = (int) (360 * (mMilliseconds % 1000) / 1000);
    }
        ...
        for (int i = 0; i < totalLines; i++) {
            ...
            if (!negativeFlag) {
                ...
                if (i >= firstLine && i <= lastLine && count < (totalLines / 4)) {
                    count++;
                    color = Color.argb(255 - ((totalLines / 4 - count) * 3), 65, 105, 225);
                } else {
                    color = Color.argb(255 - (int) (360f * 3 / (eachLineAngle * 4)), 65, 105, 225);
                }
            } else {
                //跨过起始点
                if (i >= 0 && i < lastLine) {
                    ...
                    count++;
                    color = Color.argb(255 - ((totalLines / 4 - (i - firstLine)) * 3), 65, 105, 255);
                } else {
                    color = Color.argb(255 - (int) (360f * 3 / (eachLineAngle * 4)), 65, 105, 225);
                }
            }
    ...
    //开始
    public void start(final long milliseconds) {
